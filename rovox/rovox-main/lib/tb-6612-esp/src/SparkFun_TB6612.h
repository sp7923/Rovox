...
{
  public:
    // Constructor. Mainly sets up pins and PWM channels.
    Motor(int In1pin, int In2pin, int PWMpin, int offset,int PWMChannel,int PWMFrequency,int PWMResolution);      
  ...
  private:
    //variables for the 2 inputs, PWM input, Offset value
	int In1, In2, PWM, Offset;

    // variables for PWM set up
    int PWMChannel, PWMFrequency, PWMResolution;
